...
The cart creates and captures PayPal Orders v2 payments through server-only route handlers. Product prices are recalculated from `app/data/products.ts`; totals sent by the browser are not trusted.
